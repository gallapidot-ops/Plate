  ...
  return (
    <>
      <svg className="splash-bars-svg" width="93" height="105" viewBox="0 0 93 105" fill="none">
        <rect className="splash-bar splash-bar--1" x="0"  y="55" width="18" height="50"  rx="6" fill="#1A1A2E" fillOpacity="0.35" />
        <rect className="splash-bar splash-bar--2" x="25" y="25" width="18" height="80"  rx="6" fill="#1A1A2E" fillOpacity="0.60" />
        <rect className="splash-bar splash-bar--3" x="50" y="0"  width="18" height="105" rx="6" fill="#1A1A2E" fillOpacity="1.00" />
        <rect className="splash-bar splash-bar--4" x="75" y="35" width="18" height="70"  rx="6" fill="#1A1A2E" fillOpacity="0.60" />
      </svg>
