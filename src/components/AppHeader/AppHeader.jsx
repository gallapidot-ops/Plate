    ...
    <>
      <div className="ah-logo-mark">
        <svg className="ah-bars-svg" width="93" height="105" viewBox="0 0 93 105" fill="none">
          <rect x="0"  y="55" width="18" height="50"  rx="9" fill="#F5EFE2" fillOpacity="0.40" />
          <rect x="25" y="25" width="18" height="80"  rx="9" fill="#F5EFE2" fillOpacity="0.65" />
          <rect x="50" y="0"  width="18" height="105" rx="9" fill="#F5EFE2" fillOpacity="1.00" />
          <rect x="75" y="35" width="18" height="70"  rx="9" fill="#F5EFE2" fillOpacity="0.65" />
        </svg>
