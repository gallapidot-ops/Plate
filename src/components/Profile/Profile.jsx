...
/* ── Main ── */
export default function Profile({ onOpenPlace, currentProfile, viewedProfile = null, onBack = null, onWishlistVisit = null, onGuestAction = null, refreshKey = 0, onProfileUpdated = null, onOpenInbox = null, notifCount = 0 }) {
          ...
          <div className={`pf-header-expanded${headerExpanded ? ' pf-header-expanded--open' : ''}`}>
            <div className="pf-header-expanded-inner">
              ...
              <div className="pf-header-actions">
                {onOpenInbox && (
                  <button
                    className="pf-gear-btn pf-inbox-btn"
                  ...
                  >
                    ...
                    {notifCount > 0 && (
                      <span className="pf-inbox-badge">{notifCount > 9 ? '9+' : notifCount}</span>
                    )}
                  </button>
                )}
                <button
