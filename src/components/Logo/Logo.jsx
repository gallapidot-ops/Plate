 ...
 */
export function PlateMascot({ width = 120, headFill = '#E8527A' }) {
  ...
  return (
    ...
    >
      ...
      <g className="mascot-body-group">
        ...
        {/* Head circle */}
        <circle cx="60" cy="36" r="30" stroke="#F5EFE2" strokeWidth="5" fill={headFill} />
        <text
          x="60" y="33"
          textAnchor="middle"
          fontFamily="Nunito, sans-serif"
        ...
        {/* Body */}
        <line x1="60" y1="66" x2="60" y2="148" stroke="#F5EFE2" strokeWidth="6" />

        {/* Legs */}
        <line x1="60" y1="148" x2="80" y2="202" stroke="#F5EFE2" strokeWidth="6" />
        <line x1="60" y1="148" x2="40" y2="202" stroke="#F5EFE2" strokeWidth="6" />
      </g>
      ...
      <line
        ...
        stroke="#F5EFE2" strokeWidth="6"
      />

      {/* ── Right arm (waving) — no SVG transform attr, use CSS transform-origin ── */}
