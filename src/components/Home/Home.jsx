  ...
  return (
    <div className="conv-step conv-step--meal">
      ...
      <div className="conv-footer">
        {onOpenBestMatch && (
          <button className="bm-banner" onClick={onOpenBestMatch}>
            <div className="bm-banner-left">
              <span className="bm-banner-title">Best Match ✦</span>
              <span className="bm-banner-sub">let us choose for you</span>
            </div>
            <span className="bm-banner-arrow">→</span>
          </button>
        )}
        <button
